...
Automatiseeri seesama protsess. Tagasta kõik Postimehe (või soovi korral ERR) esilehe uudiste pealkirjad (joonisel näidatud kollasega).
...
```{r}
# Ülesanne 1.6
url = "http://www.postimees.ee/" #või url = "https://www.err.ee/"
