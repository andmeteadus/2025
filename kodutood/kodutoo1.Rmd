...
-   hinnana kasuta tunnust *close*, sümbolina *symbol*, tootlus arvutada (kasutades eelmise kauplemispäeva sulgemishinda, kasuks tulevad funktsioonid `first` ja `last`), kogusena *volume*, kasumeid ja dividende aktsiate kohta tidyquant ilma API-ta ei anna, seetõttu ei pea ostusoovitusi lisama
