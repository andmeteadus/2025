...
Selles praktikumis uurimegi, kas ja kuidas saab biomarkerite abil ennustada surma. Meil on kasutada valim Geenivaramu andmestikust, mis sisaldab 5000 inimese verest mõõdetud 106 biomarkeri väärtuseid. 
...
Kuna testisime kõigi 106 biomarkeri olulisust surma ennustamisel, puutume kokku mitmese testimise probleemiga. Vaata selle kohta [koomiksit "Significant"](https://xkcd.com/882/) ning uuri wikipediast
[mitmese testimise](https://en.wikipedia.org/wiki/Multiple_comparisons_problem) ja [Bonferroni korrektsiooni](https://en.wikipedia.org/wiki/Bonferroni_correction) kohta.
Alternatiivselt võid vaadata Märt Mölsi [biostatistika kursuse](https://www-1.ms.ut.ee/mart/biostat2024/) 14. teema loengumaterjale.</p>. 
